...
<div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#384959]">
  ...
  <div
    ...
    p-10 shadow-xl"
  >
    <form className="w-[90%] h-150 max-w-125 flex flex-col items-center justify-center gap-5" onSubmit={handleSignIn}>
      <h1 className="text-blue-900 text-2xl font-semibold mb-7.5">
        ...
        text-black rounded-full text-[18px] relative'>
          ...
          *{err}
           ...
           <button className='min-w-37.5 h-15 mt-7.5 text-black font-semibold text-[19px] bg-white rounded-full ' disabled=
